...
const PPTXGEN 		= require(__dirname + '/pptxgenjs/dist/pptxgen.js');

const Presentation    = PPT_Template.Presentation;

let currentPresentation, PPTX, newSlides;

const PPTX_GENERATOR =  {

    createPresentation : function(template) {
        const deferred = new DEFERRED, _self = this;
    ...
    replaceImage : function(slide, imageName, rel){
        ...
        //const relJSON = JSON.parse(XML2JSON.toJson(slide.rel));
        //const relImage = relJSON.Relationships.Relationship[0].Target;
    ...
    addMedia: function(path){
        try{
            ...
            const bitmap = Array.prototype.slice.call(FS.readFileSync(path), 0);
    ...
    generate : function(outputPath){
        ...
        PPTX.getPPTXT().slides.forEach(function(slide){
            const cloneSlide = _self.getSlideClone(_self.getSlideCount());
